...
public class Solution {
    public int solution(int[] nums) {
        // 폰켓몬의 종류를 저장할 HashSet을 선언합니다.
        HashSet<Integer> set = new HashSet<>();
        
        // nums 배열의 모든 요소를 HashSet에 추가합니다.
        for (int num : nums) {
            set.add(num);
        }
        ...
        // 선택할 수 있는 최대 폰켓몬 종류는 set의 크기와 N/2 중 작은 값입니다.
    ...
    public static void main(String[] args) {
        ...
        // 결과 출력
        System.out.println(solution.solution(nums1)); // 2
        System.out.println(solution.solution(nums2)); // 3
        System.out.println(solution.solution(nums3)); // 2
    }
}